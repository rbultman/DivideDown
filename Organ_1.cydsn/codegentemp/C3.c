...
{
    uint8 staticBits = (C3_DR & (uint8)(~C3_MASK));
    C3_DR = staticBits | ((uint8)(value << C3_SHIFT) & C3_MASK);
}
...
{
	CyPins_SetPinDriveMode(C3_0, mode);
}
...
{
    return (C3_DR & C3_MASK) >> C3_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(C3_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & C3_0_INTR) != 0u) 
		{ 
			 C3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (C3_INTSTAT & C3_MASK) >> C3_SHIFT;
    }
